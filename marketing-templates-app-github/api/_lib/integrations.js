...
export const sendJson = (response, body, status = 200) => response.status(status).json(body);
...
export const authenticatedUser = async request => {
...
export const encryptCredentials = value => {
